...
public class conversacion {
	...
	static{
		...
		saludoInicial.add("¡Hola! Soy SONIA, una chica bot creada para organizar quedadas entre grupos de amigos que no se conocen. Prueba �");
		saludoInicial.add("¡Buenas tardes! �Est�is preparados para quedar con un magn�fico grupo de amigos y pasarlo genial?");
